...
class OrderShipmentsDataGrid extends \Webkul\Admin\DataGrids\OrderShipmentsDataGrid
{
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('shipments')
            ...
            ->select('shipments.id as shipment_id', 'shipments.increment_id as increment_id', 'ors.increment_id as shipment_order_id', 'shipments.total_qty as shipment_total_qty', 'ors.created_at as order_date', 'shipments.created_at as shipment_created_at')
